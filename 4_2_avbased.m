...
/**********************************************************************
   ...
   the correct generator gave a vector at first place (ordert according to length)
   ...
   mygt:    linear ordering on vectors containing elements from B_N using len
**********************************************************************/
   print "Uses N=",N,", n=",n,", m=",m,", gen_x=",gen_x,", gen_a=","10",", gen_b=","10",", len=LenGarside, mygt=gtAV";
   i:=1;
   results := [];
   while i le T do
