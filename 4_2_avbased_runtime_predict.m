...
function NumSuccess    (T:
			t := 9,
                        ...
                        mygt := gtAV)
/**********************************************************************
runtime measuring as in 4_2_avbased_runtime for higher length values
**********************************************************************/
   print "Uses T=",T," runs for every Test";
   ...
   print "Uses N=",N,", n=",n,", m=",m,", gen_x=",gen_x," len=LenGarside, mygt=gtAV";
   t0 := 0;
   mylen := LenGarside;
   for length in [40, 60, 80, 100] do
        gen_a := [length: i in [1..n]];
